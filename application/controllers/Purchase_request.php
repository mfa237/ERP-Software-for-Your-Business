...
class Purchase_request extends CI_Controller {
        private $limit=10;
        private $sql="select purchase_order_number,po_date,amount, i.project_code,
    ...
    function browse($offset=0,$limit=50,$order_column='purchase_order_number',$order_type='asc'){
		...
		$data['fields_caption']=array('Nomor PRQ','Tanggal','Jumlah','Proyek','Cabang','Department','Pegawai','Status');
		$data['fields']=array('purchase_order_number','po_date','amount','project_code', 
	...
	function view_detail($nomor){
        ...
        function print_bukti($nomor){
			...
			$this->load->view('purchase/print_request',$data);

...
class Shift extends CI_Controller {
	...
	private $sql="select kode,time_in,time_out,different_day from hr_shift";
	...
	function browse($offset=0,$limit=10,$order_column='company',$order_type='asc')	{
		...
		$data['fields_caption']=array('Kode','Time In','Time Out','Diff Day');
		$data['fields']=array('kode','time_in','time_out','different_day');
		$data['field_key']='kode';

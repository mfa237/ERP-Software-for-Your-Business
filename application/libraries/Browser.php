		...
		$query=$this->CI->db->query($sql);
 			...
 			if( $query )
			{
				foreach($query->result() as $row)
				{
					...
					$action="";
					if($show_edit_button)$action.="<a href='#' onclick='edit_item();return false;' value='$key_value' class='editLink btn btn-default glyphicon glyphicon-pencil' title='Edit Row'></a>"; 
					if($show_delete_button)$action.="&nbsp <a href='#' onclick='delete_item();return false;' value='$key_value' class='deleteLink btn btn-default glyphicon glyphicon-remove' title='Delete Row'></a>"; 
					if($show_view_button)$action.="&nbsp <a href='#' onclick='view_item();return false;' value='$key_value' class='viewLink btn btn-default glyphicon glyphicon-folder-open' title='View Row'></a>"; 
					$data[]=$action;

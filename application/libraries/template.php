...
class Template {
 ...
 function __construct()
 {
    ...
    $this->bootstrap_only.=$this->_ci->jquery->script(base_url().'assets/bootstrap-3.3.5/js/bootstrap.min.js',true);
    $this->bootstrap_only.=$this->_ci->jquery->script(base_url().'js/lib.js',true);
	
	$this->library_src =$this->_ci->jquery->script(base_url().'assets/jquery/jquery-1.11.3.min.js',true);
    $this->library_src.=$this->_ci->jquery->script(base_url().'assets/bootstrap-3.3.5/js/bootstrap.min.js',true);
    $this->library_src.=$this->_ci->jquery->script(base_url().'assets/datepicker/bootstrap-datepicker.js',true);
    $this->library_src.=$this->_ci->jquery->script(base_url().'assets/jquery-easyui-1.4.3/jquery.easyui.min.js',true);
    ...
    $this->library_src.=$this->_ci->jquery->script(base_url().'js/lib_error.js',true);

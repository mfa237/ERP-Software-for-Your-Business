<div class="thumbnail">
<legend>Master Data Aktiva Tetap</legend>

	<?
	echo link_button('Save', 'save_this()','save');		
	echo link_button('Print', 'print()','print');		
	echo link_button('Add','','add','true',base_url().'index.php/aktiva/add');		
	echo link_button('Search','','search','true',base_url().'index.php/aktiva');		
...
<form id="myform" role="form" method="post" action="<?=base_url()?>index.php/aktiva/save"  class="form-horizontal" >
	...
	<table class="">
		...
		<td>
			...
			name="acquisition_date" value="<?=$acquisition_date?>" placeholder="acquisition_date" style="width:150px">
		</td></tr>

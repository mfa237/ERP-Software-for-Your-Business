<div class="thumbnail">
<legend>Master Data Kelompok Aktiva Tetap</legend>

	<?
	echo link_button('Save', 'save_this()','save');		
	echo link_button('Print', 'print()','print');		
	echo link_button('Add','','add','true',base_url().'index.php/aktiva_group/add');		
	echo link_button('Search','','search','true',base_url().'index.php/aktiva_group');		
...
<form id="myform" role="form" method="post" action="<?=base_url()?>index.php/aktiva_group/save"  class="form-horizontal" >

<div id="lstPeriode" class="col-md5 thumbnail" >
	...
	<?=link_button('Reload','load_aset();return false;','reload')?> 
</div>
		...
		<table id="dgAktiva" class="easyui-datagrid"  
			...
			<thead>
				<tr>
					...
					<th data-options="field:'depr_amount',width:80">Penyusutan</th>
					<th data-options="field:'book_amount',width:80">Nilai Buku</th>
				</tr>
			</thead>
		</table>
...
<script  language="javascript">
	function load_aset() {
		...
		$('#dgAktiva').datagrid({url:'<?=base_url()?>index.php/aktiva_proses/load/'+periode});

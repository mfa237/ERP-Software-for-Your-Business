	...
	<div role="tabpanel">
		...
		<div class="tab-content">
		  <div role="tabpanel" class="tab-pane fade in active" id="tab1">
				<?=my_input_2("Kode Barang","item_number",$item_number,'','',$readonly)?>
				<?=my_input_2("Nama Barang","description",$description,'','')?>
				<? 
				...
				?>
				<?=my_input_2("Merk","manufacturer",$manufacturer,'','',$readonly)?>
				<?=my_dropdown("Category","category",$category,$cat_list,'','')?>
				<?=my_dropdown("Sub Category","sub_category",$sub_category,$cat_list,'','')?>
		  </div>
		  <div role="tabpanel" class="tab-pane fade  " id="tab2">
				<?=my_input_2("Satuan","unit_of_measure",$category,'','')?>
				<?=my_input_2("Harga Jual","retail",$retail,'','')?>
				<?=my_input_2("Harga Beli","cost",$cost,'','')?>
				<?=my_input_2("Berat Kg","weight",$weight,'','')?>
				<?=my_input_2("Kondisi","condition",$cost,'','')?>
				<?=my_input_2("Asuransi","insr_name",$insr_name,'','')?>
				<?=my_input_2("Sales Minimum","sales_min",$sales_min,'','')?>
				<?=my_input_2("Jasa Pengiriman ","delivery_by",$delivery_by,'','')?>
		  </div>
		  <div role="tabpanel" class="tab-pane fade  " id="tab3">
				<?=my_input_2("Item Picture 1","item_picture",$item_picture,'','')?>				
				<? echo "<img src=".base_url()."tmp/$item_picture>"; ?>
				<?=my_input_file("","item_picture_img",'','','')?>				
				<?=my_input_2("Item Picture 2","item_picture2",$item_picture2,'','')?>				
				<? echo "<img src=".base_url()."tmp/$item_picture2>"; ?>
				<?=my_input_file("","item_picture2_img",'','','')?>				
				<?=my_input_2("Item Picture 3","item_picture3",$item_picture3,'','')?>				
				<? echo "<img src=".base_url()."tmp/$item_picture3>"; ?>
				<?=my_input_file("","item_picture3_img",'','','')?>				
				<?=my_input_2("Item Picture 4","item_picture4",$item_picture4,'','')?>				

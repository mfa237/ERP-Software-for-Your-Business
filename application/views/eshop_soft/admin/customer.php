		...
		<div class="col-md-8">
			<div class="">
				<form  enctype="multipart/form-data" class="form-horizontal" id='frmMain' method='post' >
					...
					<?=my_input_2("Kode Pelanggan","customer_number",$customer_number)?>
					<?=my_input_2("Nama Pelanggan","company",$company)?>
					<?=my_textarea("Alamat","street",$street)?>
					<?=my_input_2("Kode Pos","zip_postal_code",$zip_postal_code)?>				
					<?=my_input_2("Phone","phone",$phone)?>				
					<?=my_input_2("Email","email",$email)?>				
					<?=my_input_2("Password","password",$password)?>				
				</form>	  
			</div>
			<div  class=''>

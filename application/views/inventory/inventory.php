<div class=""><h4>MASTER BARANG</h4><div class="thumbnail box-gradient">
	<?
	echo link_button(lang('save'), 'save()','save');		
	echo link_button(lang('print'), 'print_item()','print');		
	echo link_button(lang('add'),'','add','true',base_url().'index.php/inventory/add');		
	echo link_button(lang('search'),'','search','true',base_url().'index.php/inventory');		
	if($mode=="view") echo link_button(lang('refresh'),'','reload','true',base_url().'index.php/inventory/view/'.$item_number);		
	echo link_button(lang('picture'), 'upload_gambar()','thumbnail');		
	echo link_button(lang('import'), 'import_excel()','year');		
	echo link_button(lang('help'), 'load_help(\'inventory\')','help');	
	?>
	<a href="#" class="easyui-splitbutton" data-options="menu:'#mmOptions',iconCls:'icon-tip'">
		<?=lang('options')?></a>
	    ...
	    <tr><td>Item Number</td>
	     ...
	     <tr>
	       ...
	       <td colspan=5><?
			...
			echo link_button('','lookup_supplier()','search');
			echo form_input('supplier_name',$supplier_name," id='supplier_name' disabled style='width:70%'");

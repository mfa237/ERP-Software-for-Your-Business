...
<table width='100%' style="border:none">
	...
	<tr><td>Tanggal Lahir</td><td><?=form_input('birth_date',$birth_date,"class='easyui-datetimebox' ".$disabled);?></td></tr>
	...
	<tr><td>Masa Berlaku KTP</td><td><?=form_input('id_card_exp',$id_card_exp, "class='easyui-datetimebox'".$disabled);?></td></tr>
...
<table width='100%' style="border:none">	
	...
	<tr><td>Tgl Lahir </td><td><?=form_input('spouse_birth_date',$spouse_birth_date, "class='easyui-datetimebox'".$disabled);?></td></tr>

<div class=""><h1>MASTER MATERIAL BAHAN BAKU<div class="thumbnail">
	<?
	echo link_button('Save', 'save()','save');		
	echo link_button('Print', 'print_item()','print');		
	echo link_button('Add','','add','true',base_url().'index.php/material/add');		
	echo link_button('Search','','search','true',base_url().'index.php/material');		
	...
	<script type="text/javascript">
		function load_help() {
			window.parent.$("#help").load("<?=base_url()?>index.php/help/load/material");
		}
	</script>

...
<div class='form-group thumbnail'><p>Pilih jenis file yang diupload</p> 	
<div class="radio">
  <label>
    <input type="radio" name="app_type" id="app_type_1" value="themes" checked>
    Modul yang diupload adalah jenis thema
  </label>
</div>
...
<div class="radio form-group">
  <label>
    <input type="radio" name="app_type" id="app_type_3" value="books">
    File yang diupload adalah buku atau tutorial.
  </label>
</div>

</div>
<div class='form-group thumbnail'><p>Pilih jenis lisensi file yang diupload</p> 	
<div class="radio">
  <label>
    <input type="radio" name="lic_type" id="lic_type_1" value="free" checked>
    Lisensi aplikasi / thema free
  </label>
</div>
<div class="radio form-group">
  <label>
    <input type="radio" name="lic_type" id="lic_type_2" value="paid">
    Lisensi aplikasi / thema berbayar.
  </label>
</div>
</div>
<div class='thumbnail'>	
<div class="form-group">
    ...
    <input type="file" id="app_ico" name="app_ico">
...
<div class='thumbnail'>
	...
	<div class="form-group">
		...
		<input type="file" id="app_scr_1" name="app_scr_1">
		<p class="help-block">Pilih nama file.</p>
	</div>
	<div class="form-group">
		<label for="app_ico">Screenshoot 2</label>
		<input type="file" id="app_scr_2" name="app_scr_2">
		<p class="help-block">Pilih nama file.</p>
	</div>
	<div class="form-group">
		<label for="app_ico">Screenshoot 3</label>
		<input type="file" id="app_scr_3" name="app_scr_3">
		<p class="help-block">Pilih nama file.</p>
	</div>
	<div class="form-group">
		<label for="app_ico">Screenshoot 4</label>
		<input type="file" id="app_scr_4" name="app_scr_4">
		<p class="help-block">Pilih nama file.</p>
	</div>
	<div class="form-group">
		<label for="app_ico">Screenshoot 5</label>
		<input type="file" id="app_scr_5" name="app_scr_5">
		<p class="help-block">Pilih nama file.</p>
	</div>

<div id='dlgSelectReceive'class="easyui-dialog" style="width:600px;height:380px;padding:10px 20px"
...
<div id="btnSelectReceive" style="height:auto">
	<a href="#" class="easyui-linkbutton" iconCls="icon-ok" plain="true" onclick="selected_received_no()">Proses</a>
</div>

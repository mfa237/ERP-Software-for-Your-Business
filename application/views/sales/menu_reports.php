...
<li><?=anchor('sales/rpt/so_otstand_item','Open Sales Order by Item Number',"class='info_link'")?></li>
<li><?=anchor('sales/rpt/so_otstand_cust','Open Sales Order by Customer Number',"class='info_link'")?></li>

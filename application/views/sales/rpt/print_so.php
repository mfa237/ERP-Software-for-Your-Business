...
<table cellspacing="0" cellpadding="1" border="0" width='800px'> 
     <tr>
     	<td colspan='2'><h2><?=$model->company_name?></h2></td><td colspan='2'><h2>SALES ORDER</h2></td>     	
     </tr>
     <tr>
     	<td colspan='2'><?=$model->street?></td><td>Nomor: <?=$sales_order_number?></td>     	
     </tr>
     <tr>
		       ...
		       $sql="select item_number,description,quantity,unit,discount,price,amount 
		        ...
		        $query=$CI->db->query($sql);
                 ...
                 foreach($query->result() as $row){
                    ...
                    $tbl.="<td align='right'>".($row->discount)."</td>";

			...
			<li><?=anchor('inventory/rpt/cards_supplier','Laporan Kartu Stock Per Supplier',"class='info_link'")?></li>
			<li><?=anchor('inventory/rpt/cards_category','Laporan Kartu Stock Per Kategori',"class='info_link'")?></li>

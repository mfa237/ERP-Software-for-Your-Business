<div id="dlgUnitPrice" class="easyui-dialog"  buttons="#tbUnitPrice"
	...
	<table class="table2" width="100%">
		...
		<tr><td>From Qty</td><td><input type="text" name="quantity_high" id="quantity_high"></td></tr>
		<tr><td>To Qty</td><td><input type="text" name="quantity_low" id="quantity_low"></td></tr>

<legend>MATERIAL BAHAN BAKU</legend>
<div class="thumbnail box-gradient">
	<?
	echo link_button('Save', 'save()','save');		
	echo link_button('Print', 'print_item()','print');		
	echo link_button('Add','','add','true',base_url().'index.php/manuf/material/add');		
	echo link_button('Search','','search','true',base_url().'index.php/manuf/material');		
	echo link_button("Gambar", 'upload_gambar()','thumbnail');		
	if($mode=="view") echo link_button('Refresh','','reload','true',base_url().'index.php/manuf/material/view/'.$item_number);		
 ...
 <script language='javascript'>
	var url;	
  	...
  	function save(){
		...
		url='<?=base_url()?>index.php/material/save';

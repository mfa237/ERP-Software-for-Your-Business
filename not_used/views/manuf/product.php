...
<div class="thumbnail box-gradient">
	...
	echo link_button('Add','','add','true',base_url().'index.php/manuf/product/add');		
	echo link_button('Search','','search','true',base_url().'index.php/manuf/product');		
	echo link_button("Gambar", 'upload_gambar()','thumbnail');		
	if($mode=="view") echo link_button('Refresh','','reload','true',base_url().'index.php/manuf/product/view/'.$item_number);		
	echo link_button('Import', 'import_excel()','year');		
	echo link_button('Help', 'load_help(\'product\')','help');		
	?>

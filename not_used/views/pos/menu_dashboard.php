	...
	<div class='pos-content'>
		...
		<div class='col-sm-8 thumbnail'>
			...
			<div class='col-md-12 thumbnail box-gradient' style='margin-bottom: 5px;'>
			 ...
			 <div class='category' style='max-height:150px'>
...
<div id='dlgSet' class="easyui-dialog" style="width:600px;height:450px;padding:10px 20px" closed="true" 
...
<div id='dlgPay' class="easyui-dialog" style="width:600px;height:450px;padding:10px 20px" closed="true" 

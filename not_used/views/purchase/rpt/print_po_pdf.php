	   ...
	   $sql="select item_number,description,quantity,unit,discount,
		...
		$tbl="";
		 foreach($query->result() as $row){
			...
			$tbl.="<td width=\"30\" align=\"right\">".number_format($row->discount)."</td>";
			$tbl.="<td width=\"30\" align=\"right\">".number_format($row->disc_2)."</td>";
			$tbl.="<td width=\"30\" align=\"right\">".number_format($row->disc_3)."</td>";
